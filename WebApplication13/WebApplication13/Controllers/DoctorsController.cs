...
namespace WebApplication13.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public DoctorsController(HosptialContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Doctors != null ? 
                          ...
                          Problem("Entity set 'HosptialContext.Doctors'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,name,speciality")] Doctor doctor)
        {
            if (id != doctor.id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HosptialContext.Doctors'  is null.");
            }
            var doctor = await _context.Doctors.FindAsync(id);
            if (doctor != null)
            {
